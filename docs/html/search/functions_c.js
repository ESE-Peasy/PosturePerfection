...
[
  ...
  ['set_329',['set',['../CMakeLists_8txt.html#af88130ecb388b2b4482da7b913adf3bf',1,'set(CMAKE_CXX_STANDARD 11) cmake_minimum_required(VERSION 3.16) project(PosturePerfection VERSION 0.3.0) set(CMAKE_CXX_LINK_FLAGS &quot;$:&#160;CMakeLists.txt'],['../CMakeLists_8txt.html#a7b7902e413b859f92d83fa46364199dc',1,'set(NTFYSRC notifications/notify.cpp notifications/client.cpp notifications/server.cpp) set(LIBSRC iir.cpp inference_core.cpp post_processor.cpp pre_processor.cpp posture_estimator.cpp pipeline.cpp) set(OpenCV_DIR &quot;$:&#160;CMakeLists.txt'],['../gui_2CMakeLists_8txt.html#ac9a44e066b779d84926d1fc478e53957',1,'set(CMAKE_CXX_STANDARD 11) set(CMAKE_CXX_STANDARD_REQUIRED ON) set(CMAKE_AUTOMOC ON) set(CMAKE_AUTORCC ON) set(CMAKE_AUTOUIC ON) find_package(Qt5 COMPONENTS Widgets PrintSupport REQUIRED) find_package(QCustomPlot) if(NOT TENSORFLOW_SOURCE_DIR) get_filename_component(TENSORFLOW_SOURCE_DIR &quot;$:&#160;CMakeLists.txt']]],
